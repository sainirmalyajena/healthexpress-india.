...
function createSurgery(
    ...
    return {
        ...
        slug,
        category,
        overview: `${name} is a ${insurance ? 'commonly performed' : 'specialized'} procedure in ${getCategoryName(category)}. This surgery is designed to address specific medical conditions and improve patient quality of life. Our partner hospitals across India offer this procedure with experienced surgeons and modern facilities.`,
        ...
        procedure: `The ${name} procedure typically involves: 1) Pre-operative preparation and anesthesia administration, 2) The surgical intervention using appropriate technique (open or minimally invasive depending on the case), 3) Careful closure and wound care, 4) Recovery monitoring in the post-anesthesia care unit. The specific approach depends on individual patient factors and surgeon preference.`,
        duration,
        hospitalStay: stay,
        recovery: `Recovery from ${name} varies by individual. Most patients can resume light activities within 1-2 weeks, with full recovery typically taking 4-8 weeks. Follow your surgeon's specific instructions regarding activity restrictions, wound care, and follow-up appointments.`,
