...
export const metadata = {
    title: 'Contact Us',
    description: 'Get in touch with HealthExpress India. We\'re here to help you find the right surgery and hospital.',
};
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-teal-600 font-medium">hello@healthexpress.in</p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 text-sm">
                                            HealthExpress India Pvt. Ltd.<br />
                                            123, Healthcare Tower<br />
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-xl shadow-sm p-8">
                            ...
                            <p className="text-slate-600 mb-8">
                                Not sure which surgery you need? Tell us about your symptoms and we&apos;ll help you find the right treatment.
                            </p>

                            {/* We'll use a simplified version - redirect to surgery page for full form */}
                            <div className="bg-teal-50 border border-teal-200 rounded-lg p-6 text-center">
                                <p className="text-teal-700 mb-4">
                                    For surgery-specific inquiries, please browse our directory and submit the form on the surgery page.
                                </p>
                                <Link
                                    href="/surgeries"
                                    className="inline-flex px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg transition-colors"
                                >
                                    Browse Surgeries
                                </Link>
                            </div>
